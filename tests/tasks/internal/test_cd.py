...
class TestCd(TestCase):
    ...
    def test_up_without_arg(self, list_entries_mock, parent_shell_mock, int_prompt_mock):
        ...
        list_entries_mock.return_value = [SearchEntry(host='github.com', organization='acme', repository='b')]
    ...
    def test_up_fuzzy_search(self, add_row_mock, list_entries_mock, parent_shell_mock, int_prompt_mock):
    ...
    def test_up_fuzzy_search_without_hits(self, console_print_mock, list_entries_mock):
        ...
        console_print_mock.assert_called_once_with('Could not find any repositories matching [b]d[/]', style='red')
